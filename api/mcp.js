...
export function buildTopicSummary(input) {
...
export function buildTopicSummaryOutput(input) {
  const title = cleanText(input.title) || "Untitled topic";
...
export function translateTextToFrench(text) {
...
export function buildFrenchTranslationOutput(text) {
...
export function createTopicEarthMcpServer() {
