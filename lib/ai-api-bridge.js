  ...
  const bridge = new window.SmartAiApiBridge({
    ...
    onSummary: (summary) => {
      Settings.set({
        ...
        aiApiTextMaxModel: summary.textMaxModel || Settings.get().aiApiTextMaxModel || '',
        aiApiTextMaxDetectedAt: summary.textMaxDetectedAt || Settings.get().aiApiTextMaxDetectedAt || null,
