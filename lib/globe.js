  ...
  async loadSolarSystem() {
    ...
    try {
      const gltf = await new Promise((resolve, reject) => {
        loader.load(
          assetPath(MODEL_ASSET_BASE, 'solar-system.glb'),
          resolve,
          undefined,
          reject
        );
  ...
  onMouseClick(event) {
    ...
    if (this.inSolarSystemView && this.solarSystemModel) {
      ...
      if (solarSystemIntersects.length > 0) {
        ...
        const validPlanetNames = ['Sun', 'Mercury', 'Venus', 'Earth', 'Moon', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Spaceship', 'StarShip', 'Asteroid', 'Asteroid2', 'Astroid', 'Astroid2', 'Atlas31', 'Atlas32'];
