...
import { resolveAssetUrl } from './asset-bridge.js?v=topic-earth-solar-cloudinary-20260504';
...
export class GlobeRenderer {
  ...
  async enterFeverMode() {
    ...
    if (needsReload) {
      this.showLoadingBar('Loading Fever loop...');
  ...
  showLoadingBar(label = 'Loading Globe...') {
    if (!this.loadingBar) {
    ...
    const text = this.loadingBar.querySelector('.loading-bar-text');
    if (text) {
