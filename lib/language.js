import {
  ...
  applyTranslationCsv
} from './translations.js?v=topic-earth-meteo-draft-20260531';
...
export class LanguageManager {
  ...
  static DEFAULT_TRANSLATION_CSV_URLS = [
  ...
  static async loadTranslationCatalog(url = this.DEFAULT_TRANSLATION_CSV_URLS) {
    ...
    try {
      for (const csvUrl of urls) {
        try {
          ...
          if (csvUrl === urls[urls.length - 1]) throw error;
        }
      }
    } catch (error) {
