...
export class Settings {
  ...
  static API_SETTINGS_WIDGET_URLS = {
    USER: 'https://widgets.smdeltart.com/api-settings.html',
    ADMIN: 'https://widgets.smdeltart.com/?app=api'
  };
  ...
  static DEFAULT_SETTINGS = {
    ...
    aiApiSettingsFrameUrl: 'https://widgets.smdeltart.com/api-settings.html',
  ...
  static sanitize(settings = {}) {
    ...
    if (this.isLocalApiSettingsUrl(sanitized.aiApiSettingsFrameUrl)) {
      sanitized.aiApiSettingsFrameUrl = this.API_SETTINGS_WIDGET_URLS.USER;
    }
